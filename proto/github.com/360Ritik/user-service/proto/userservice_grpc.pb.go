...
const (
	...
	UserService_AddNewUser_FullMethodName    = "/proto.UserService/AddNewUser"
)
...
type UserServiceClient interface {
	...
	GetUsersByIds(ctx context.Context, in *UsersByIdsRequest, opts ...grpc.CallOption) (*UsersResponse, error)
...
func (c *userServiceClient) GetUsersByIds(ctx context.Context, in *UsersByIdsRequest, opts ...grpc.CallOption) (*UsersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *userServiceClient) AddNewUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
type UserServiceServer interface {
	...
	GetUsersByIds(context.Context, *UsersByIdsRequest) (*UsersResponse, error)
...
func (UnimplementedUserServiceServer) GetUserById(context.Context, *UserByIdRequest) (*UserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUserById not implemented")
}
func (UnimplementedUserServiceServer) GetUsersByIds(context.Context, *UsersByIdsRequest) (*UsersResponse, error) {
...
func (UnimplementedUserServiceServer) AddNewUser(context.Context, *User) (*User, error) {
...
func _UserService_AddNewUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).AddNewUser(ctx, req.(*User))
	}
	return interceptor(ctx, in, info, handler)
}
